package badentities.azerian.skywars;

import badentities.azerian.skywars.cmds.CheckState;
import badentities.azerian.skywars.cmds.Restart;
import badentities.azerian.skywars.cmds.StartGame;
import badentities.azerian.skywars.gamehandlers.*;
import badentities.azerian.skywars.stats.GameProfileManager;
import badentities.azerian.skywars.gameutilities.Kits;
import badentities.azerian.skywars.gameutilities.Utils;
import com.sk89q.worldedit.Vector;
import com.sk89q.worldedit.bukkit.WorldEditPlugin;
import com.sk89q.worldedit.bukkit.selections.CuboidSelection;
import badentities.azerian.skywars.gameutilities.GameState;
...
public class SkyWars extends JavaPlugin {
    ...
    private static SkywarsManager gameManager;
    ...
    public void onEnable() {
        Utils.loadMap(SkywarsManager.GAME_WORLD);
        Bukkit.getWorld(SkywarsManager.GAME_WORLD).setAutoSave(false);
        Bukkit.getWorld(SkywarsManager.GAME_WORLD).setMonsterSpawnLimit(0);
        Bukkit.getWorld(SkywarsManager.GAME_WORLD).setWaterAnimalSpawnLimit(0);
        Bukkit.getWorld(SkywarsManager.GAME_WORLD).setAnimalSpawnLimit(0);
        plugin = this;
        pluginListener = new PluginListener();
        gameRunning = true;
        gameManager = new SkywarsManager();
        ...
        getServer().getPluginManager().registerEvents(new PreIG(this), this);
        ...
        world = Bukkit.getWorld(SkywarsManager.GAME_WORLD);
    ...
    public static SkywarsManager getGameManager() {
        return gameManager;
    }
